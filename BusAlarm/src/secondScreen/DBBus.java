	...
	public DBBus() {
		...
		try {
			...
			for(cnt=0; cnt<45; cnt++) {
				...
				bus_num = ((int) (randomValue * 8999)) + 1000;
				
				low_floor_bus = (int) (randomValue * 2)+5;
				if (low_floor_bus == 5) {
					low_floor_bus = 1;
					seat_num = 24;
				} else {
				...
				String sql = "insert into bus_info (bus_num, low_floor_bus, seat_num) values(" + bus_num + ", " + low_floor_bus + ", " + seat_num + ")";
